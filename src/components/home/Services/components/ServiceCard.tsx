  ...
  return (
    ...
    >
      <div className="relative h-[35dvh]  lg:h-[20dvh] xl:h-[30dvh] w-full">
        ...
        {/* Title */}
        <div
          className={`absolute inset-0 bg-black bg-opacity-50 text-center flex items-center justify-center text-white text-4xl lg:text-2xl xl:text-4xl  uppercase  ${noto_200.className}`}
        >
          <h3>{title}</h3>
        </div>
